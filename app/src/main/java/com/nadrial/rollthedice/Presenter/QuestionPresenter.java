...
import com.nadrial.rollthedice.Interactor.QuestionInteractor;
import com.nadrial.rollthedice.R;
import com.nadrial.rollthedice.Router.Router;
import com.nadrial.rollthedice.View.DiceView;
import com.nadrial.rollthedice.View.ResultsView;
        ...
        new Handler().postDelayed(new Runnable() {
            ...
            public void run() {
                if (answer.equals(correctAnswer)) {
                    ...
                    switch (categoria){
                        case 0:
                            Counter.incrementNatCount();
                            break;
                        case 1:
                            Counter.incrementMitCount();
                            break;
                        case 2:
                            Counter.incrementFoodCount();
                            break;
                        case 3:
                            Counter.incrementTripCount();
                            break;
                        case 4:
                            Counter.incrementTechCount();
                            break;
